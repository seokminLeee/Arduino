#define TRIG1 3 //초음파 센서1번 Trig핀번호
#define ECHO1 4 //초음파 센서1번 ECHO핀번호

#define TRIG2 5 //초음파 센서1번 Trig핀번호
#define ECHO2 6 //초음파 센서1번 ECHO핀번호

#define TRIG3 7 //초음파 센서1번 Trig핀번호
#define ECHO3 8 //초음파 센서1번 ECHO핀번호
